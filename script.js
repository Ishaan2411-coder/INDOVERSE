...
function processAiQuestion(userQuery) {
    ...
    typingDiv.innerHTML = `
        ...
        <div class="msg-bubble"><em>SAHAY searching Indoverse archives...</em></div>
    `;
...
<em>This question is outside my reach. I am SAHAY — trained only on the stories, characters, and lore of the Indoverse universe.</em>`);
            return;
        }
        ...
        // Generic fallback
        appendMessage("bot", `🟢 <strong>SAHAY AI</strong><br><br>
